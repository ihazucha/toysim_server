...
class Messaging:
    def __init__(self):
        ...
        self.q_real = MPMCQueue(name="real", addr_type=AddrType.TCP, ports=(11001, 11002), q_size=1)
        ...
        self.q_ui = MPMCQueue(name="ui", addr_type=AddrType.TCP, ports=(10061, 10062), q_size=1)
