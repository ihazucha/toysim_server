...
class Messaging:
    def __init__(self):
        self.q_simulation = SPMCQueue(name="simulation", type=SPMCQueueType.TCP, port=10001)
        self.q_sensor_fusion = SPMCQueue(name="sensor_fusion", type=SPMCQueueType.TCP, port=10002)
